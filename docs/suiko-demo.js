...
// `node kr-patch/tools/demo-menu.js --emit-patch docs/demo-patch.json` (one byte, for the
  ...
  function patchDemoMenu(baseName) {
    ...
    return fetch(PATCH_URL)
      ...
      .then(function (patch) {
        ...
        // demo-patch.json would otherwise scribble over whatever now lives at those offsets.
